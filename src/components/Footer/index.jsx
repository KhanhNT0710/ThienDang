            ...
            <Row className="footer-container">
                <div class="phone_mobi">
                    <ul>
                        ...
                        <li>
                            <a href="http://m.me/denlongthiendang" >
                        ...
                        <li >
                            <a href="http://zalo.me/0988015093" >
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="16" height="16" viewBox="0,0,256,256">
                        ...
                        <li >
                            <a href="http://maps.app.goo.gl/BSec4jZepiQVDknx9" >
                ...
                <Col className="footer-item" xs={24} sm={12} md={8}>
                    ...
                    <div className="footer-item__description-grp">
                        ...
                        <p className="footer-item__description"><a target="_blank" href="http://zalo.me/0988015093">Điện thoại: 0988015093</a></p>
                        <p className="footer-item__description"><a target="_blank" href="http://maps.app.goo.gl/BSec4jZepiQVDknx9">Google Map</a></p>
                ...
                <Col className="footer-item" xs={24} sm={12} md={8}>
                    <iframe width="380" height="200" src="http://www.youtube.com/embed/5kcWllSaGWY?si=tGIMIFXpXJNAL67c"
