...
const FooterComponent = () => {
  return (
    <div className="footer-wrapper">
      <Row className="footer-container gap-3">
        ...
        <Col className="footer-item gap-3" xs={24} sm={12} md={12}>
          ...
          <div className="footer-item__description-grp">
            ...
            <p className="footer-item__description">
              <a
                target="_blank"
                href="https://maps.app.goo.gl/BSec4jZepiQVDknx9"
              >
                Google Map
              </a>
            </p>
            <p className="footer-item__description">
              <a
                href="mailto:denlongthiendang@gmail.com"
                title="denlongthiendang@gmail.com"
              >
                denlongthiendang@gmail.com
              </a>
            </p>
          </div>
